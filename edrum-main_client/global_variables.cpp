...
Gtk::Button *pButton_song_play = nullptr;
Gtk::Button *pButton_delete = nullptr;
Gtk::Button *pButton_song_conversion = nullptr;
Gtk::Button *pButton_record = nullptr;
Gtk::Button *pButton_upload = nullptr;
